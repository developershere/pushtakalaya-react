                            ...
                            <div className="mobile-menu">
                                <nav id="mobile-menu-active">
                                    <ul id="nav">
                                        ...
                                        </li>{currentUser ? <li><Link onClick={signOut}>SignOut</Link></li> : <li><a href="#">MyAccount<i className="fa fa-angle-down"></i></a>
                                            <div className="sub-menu sub-menu-2">
                                                <ul>
                                                    <li><Link to='/signup'>SignUp</Link></li>
                                                    <li><Link to='/signin'>SignIn</Link></li>
                                        ...
                                        <li><Link to='/donate'>Donate Books<i className="fa fa-angle-down"></i></Link></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
